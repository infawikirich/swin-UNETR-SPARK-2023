        ...
        for idx, batch_data in enumerate(loader):
            ...
            if output_dir:
                for i, val_output in enumerate(val_output_convert):
                    case_id = os.path.join(data_dir, "ASNR-MICCAI-BraTS2023-SSA-Challenge-TrainingData_V2").split("-")[3]
                    timepoint = "000"
...
# torch.save(model.state_dict(), "./model_AdamW_CosineAnnealing_V2.pth")
...
# save the graph to the current directory
# plt.savefig("plot_graph_AdamW_CosineAnnealing_V2.png")
